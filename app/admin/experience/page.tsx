    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-[var(--text-muted)]">Manage your work history.</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-20 admin-panel">
          <p className="text-[var(--text-muted)] mb-4">No experience added yet.</p>
        ...
        <div className="space-y-4">
          {items.map(item => (
            <div key={item.id} className="admin-panel p-5 flex items-center justify-between group">
              <div>
                <h3 className="font-semibold text-[var(--text)]">{item.role}</h3>
                <p className="text-sm text-[var(--text-muted)]">{item.company} <span className="mx-2">•</span> {item.period}</p>
              </div>
