    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-[var(--text-muted)]">Manage your credentials and courses.</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-20 admin-panel">
          <p className="text-[var(--text-muted)] mb-4">No certifications added yet.</p>
          ...
          {items.map(item => (
            <div key={item.id} className="admin-panel p-5 flex items-center justify-between group">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-[var(--text)] line-clamp-1">{item.title}</h3>
